...
library("yuima")
dyn.load("gaborlib")
H0 <- 75 #Definitely pushes the edges out. But creates wide swings --====-- 75 was good!
a <- (1/70)#70 works well for almost all 
b <- (1/5)
...
Obs <- c(100)
mcoeff <- 0.45 #Less than the exact modulus of continuity.
